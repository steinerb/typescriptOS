...
(function (TSOS) {
    var Shell = (function () {
        ...
        Shell.prototype.init = function () {
            ...
            this.commandList[this.commandList.length] = sc;
            // guess <int>
            sc = new TSOS.ShellCommand(this.shellGuess, "guess", "<int> - Compares your input to a random numb  er, 1-10.");
            this.commandList[this.commandList.length] = sc;
            // roll <int>
            ...
            this.commandList[this.commandList.length] = sc;
            // test
            sc = new TSOS.ShellCommand(this.shellTest, "test", "- A shell command for the developer to experimen  t with new shell commands.");
            this.commandList[this.commandList.length] = sc;
