    ...
    var Shell = (function () {
        ...
        Shell.prototype.shellLoad = function (args) {
            ...
            if (!TSOS.Utils.isValidHexString(dataSTR))
                ...
                //Create a new PCB and add to Resident Queue
                _ResidentQueue.enqueue(new TSOS.Pcb("new", _NextAvailablePID, 0, 0, 0, 0, 0));
                //now load to memory
                ...
                // save Program ID for later calling
        ...
        Shell.prototype.shellTest = function () {
            ...
            //Resident Queue test
            _StdOut.putText(_ResidentQueue.toString());
            //PCB test
